...
class SupportVectorMachine:
    ...
    def fit(self, data):
        ...
        self.MaxFeatureVal = max(all_data)
        self.MinFeatureValue = min(all_data)
        all_data = None

        step_size = [self.MaxFeatureVal * 0.1,
        ...
        for step in step_size:
            ...
            optimize = False
            while not optimize:
                for b in np.arange(-1*(self.MaxFeatureVal*b_range_multiple), self.MaxFeatureVal*b_range_multiple, step*b_multiple):
    ...
    def visualize(self):
        ...
        datarange = (self.MinFeatureValue*0.9, self.MaxFeatureVal*1.1)
